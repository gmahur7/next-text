...
CREATE TABLE "chat_groups_users" (
    ...
    CONSTRAINT "chat_groups_users_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "chat_groups_users" ADD CONSTRAINT "chat_groups_users_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "chat_groups"("id") ON DELETE CASCADE ON UPDATE CASCADE;
